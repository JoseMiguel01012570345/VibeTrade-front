...
### Acuerdos en el chat: edición, baja y confianza

- **Edición en cualquier momento:** El vendedor puede **editar** el texto y condiciones del acuerdo **también después** de que el comprador lo haya aceptado. Al hacerlo, el acuerdo **vuelve a quedar pendiente** de respuesta del comprador: debe **aceptarlo o rechazarlo** de nuevo.
- **Eliminación:** Sólo se puede **eliminar** un acuerdo que **todavía no** haya sido aceptado (por ejemplo pendiente o rechazado). Los acuerdos **ya aceptados** no se borran del flujo; en su lugar el vendedor puede **editarlos** y reabrir la validación del comprador.
- **Rechazo del comprador tras una nueva versión:** Si el comprador **rechaza** la versión editada del acuerdo, **no abandona el chat**: continúa en el hilo y puede seguir la conversación; el vendedor puede enviar otra propuesta o ajustar de nuevo.
- **Aviso antes de editar (vendedor):** Antes de abrir el formulario de edición de un **acuerdo** o de una **hoja de ruta**, el vendedor ve un **modal de advertencia** con la opción de **cancelar** o **continuar**. El mensaje deja claro que llevar adelante la edición puede **reducir su barra de confianza** en la plataforma, porque está alterando compromisos ya visibles para la contraparte.
- **Misma regla para la hoja de ruta:** Quien edita la **hoja de ruta** en el chat (con el permiso correpondiente) también recibe el **mismo tipo de aviso** sobre la **barra de confianza** antes de confirmar que quiere modificar.
- **Vínculo acuerdo–hoja al editar el acuerdo:** Si el acuerdo tenía una **hoja de ruta vinculada** y en esa hoja **aún no hay transportistas con tramos confirmados** (nadie dado de alta como aceptado en la operación de transporte), la plataforma **puede desvincular** automáticamente esa hoja del acuerdo al guardar la edición, para no arrastrar un encaje desactualizado. Si **ya** hay transportistas confirmados en la hoja, el vínculo se **mantiene** hasta que las reglas de negocio permitan desvincular manualmente según el estado de publicación y validaciones.
- **Invariante hojas vs acuerdos:** El número de **hojas de ruta** del hilo puede ser **menor o igual** al de **acuerdos**, **nunca mayor**. Al **crear** una hoja nueva, la plataforma lo impide si ya se alcanzó el tope (hay que emitir otro acuerdo primero o eliminar una hoja).
- **Eliminar un acuerdo cuando hay demasiadas hojas:** Si el vendedor intenta **eliminar** un acuerdo y eso dejaría **más hojas que acuerdos**, no se permite el borrado directo: se abre un **modal** que explica la regla y pide **eliminar al menos una hoja de ruta** antes de poder borrar el acuerdo. En ese modal las hojas se muestran en **vista previa** (resumen) en una **grilla** para elegir cuál sacar; sólo se ofrece eliminar hojas que **no** tengan ya transportistas con tramo **confirmado** en la oferta pública (las postulaciones pendientes no bloquean). Si ninguna hoja es eliminable por ese motivo, el modal indica el bloqueo operativo. Cuando el conteo vuelve a ser coherente, el mismo modal ofrece **confirmar la eliminación del acuerdo**.
...
9. **Ajustes posteriores por el vendedor (hoja de ruta):** El vendedor puede seguir editando la hoja de ruta desde el panel del chat, incluido el **teléfono de contacto por tramo**. Antes de editar ve el **aviso de impacto en la barra de confianza** (véase sección *Acuerdos en el chat*). Tras guardar, los **transportistas** que ya participan en el hilo pueden **aceptar o rechazar** esos cambios según el flujo operativo de la demo; un rechazo no expulsa por sí solo al comprador del chat operativo de la compra (reglas distintas para comprador vs transportista en cada caso).
