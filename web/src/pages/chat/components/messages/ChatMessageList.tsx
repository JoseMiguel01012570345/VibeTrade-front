...
type Me = { id: string; name: string; phone: string; trustScore: number }
          ...
          >
            ...
            <div
              className={cn(
                ...
                !system && mine && 'col-start-1 justify-self-end bg-[color-mix(in_oklab,var(--primary)_6%,var(--surface))]',
            ...
            >
              {!system && (
                <div className="mb-1.5 flex items-center justify-between gap-2.5 text-xs">
                  <span className="font-black">{mine ? me.name : store.name}</span>
