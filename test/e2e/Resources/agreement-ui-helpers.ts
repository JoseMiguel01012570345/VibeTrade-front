...
async function fillMerchandiseBuyerFields(page: Page, lineIndex: number) {
...
async function fillServiceSchedule(page: Page, wizard: Locator): Promise<void> {
  ...
  await sched.getByRole("button", { name: new RegExp(`^${month}$`, "i") }).click();
