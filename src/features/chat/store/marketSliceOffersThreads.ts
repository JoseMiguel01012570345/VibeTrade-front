...
import { hasValidationErrors, validateTradeAgreementDraft } from "@features/chat/model/tradeAgreementValidation"
import { fetchOfferQaFromServer, postOfferInquiry } from "@features/market/api/marketPersistence"
...
import { disconnectFromChatThread } from "@features/chat/model/chatRealtime"
import {
...
import type { MarketState, Offer, Message, QAItem, Thread } from '@features/market/model/store/marketStoreTypes'
import {
...
import { routeSheetHasConfirmedCarriers } from '@features/market/model/store/marketSliceHelpers'
import type { MarketSliceGet, MarketSliceSet } from '@features/market/model/store/marketSliceTypes'
import { resolveBuyerUserId, resolveSellerUserId } from "@features/chat/model/chatParticipantLabels"
import {
