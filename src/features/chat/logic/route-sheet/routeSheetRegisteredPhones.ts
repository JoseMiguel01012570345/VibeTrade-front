import type { ThreadChatCarrier } from "@features/chat/Dtos/thread/threadTypes";
import type { TransportistaPhoneOption } from "@features/chat/Dtos/route-sheet/routeSheetRegisteredPhonesTypes";
