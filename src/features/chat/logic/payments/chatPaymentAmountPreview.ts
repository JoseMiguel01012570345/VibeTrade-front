...
import type { AgreementPaymentPreview } from "@features/chat/Dtos/payments/chatPaymentAmountPreviewTypes";
import {
...
/** Unidades mayores → unidad mínima de moneda (p. ej. USD/ARS: centavos). */
