...
import { invalidateNotificationsQuery } from "@features/chat/lib/queryInvalidation";
import { syncChatNotificationsFromServer } from "@features/notifications/logic/notificationsSync";
import { getSessionToken } from "@shared/services/http/sessionToken";
import { postNotifyParticipantLeft } from "@features/chat/api/chatApi";
import type {
  ChatMessageDto,
  ChatThreadDto,
...
} from "@features/chat/Dtos/realtime/chatRealtimeTypes";
...
} from "@features/chat/logic/thread/chatInboundUi";
...
function handleIncomingPersistedChatMessage(dto: ChatMessageDto): void {
  ...
  void syncChatNotificationsFromServer().then(() => invalidateNotificationsQuery());
