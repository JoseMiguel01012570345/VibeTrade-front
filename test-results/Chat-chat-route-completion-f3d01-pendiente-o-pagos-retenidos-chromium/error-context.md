...
- Name: Chat\chat-route-completion-agreement-evidence.spec.ts >> chat route completion — agreement merchandise evidence >> R-CE02: salida bloqueada con evidencia pendiente o pagos retenidos
- Location: test\e2e\test-feats\Chat\chat-route-completion-agreement-evidence.spec.ts:112:3
